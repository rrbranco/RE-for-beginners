...
\ifdefined\BRAZILIAN{}
\newcommand*{\PTBR}[1]{\iflanguage{portuguese}{#1}{}}
\else
\newcommand*{\PTBR}[1]{}
\fi
...
\newcommand{\PrintfSeveralArgumentsSectionName}{printf() \RU{с несколькими аргументами}\EN{with several arguments}\PTBR{com vários argumentos}\ES{con varios argumentos}\ITA{con più argomenti}\FR{avec plusieurs arguments}}
...
\newcommand{\MLStackOverflow}{\EN{Stack overflow}\RU{Переполнение стека}\PTBR{\TBT}\FR{Débordement de pile}\DEph{}\ITA{Stack overflow}}
