...
\Huge%
	...
	\PTBRph{Cuidado: Esta é uma versão LITE(resumida)}%
	\DEph{}%
	\PLph{}%
	\ITAph{}
\normalsize
...
\PTBRph{Esta é uma versão aproximadamente 6 vezes menor do que a versão completa (\textasciitilde{}150 páginas) e é direcionada a aqueles que querem uma versão de rapida introdução a o básico de engenharia reversa.
Não há nada sobre MIPS, ARM, OllyDBG, GCC, GDB, IDA, não há exercícios, exemplos, \etc{}.}%
\DEph{}%
\PLph{}%
\ITAph{}
\normalsize
...
\PTBRph{Se tiver mais interesse em engenharia reversa, uma versão completa do livro estará sempre disponivel no meu site:}%
\DEph{}%
\PLph{}%
\ITAph{}
