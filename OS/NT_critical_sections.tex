\subsection{Windows NT: \RU{Критические секции}\EN{Critical section}\DE{Kritischer Abschnitt}}
\myindex{Windows}
...
\RU{Ожидание там сделано через вызов}\EN{The wait is performed there using} WaitForSingleObject(). \\
\\
...
\RU{В данном случае, это значит прибавить 1 к значению в \TT{LockCount}, при этом сохранить изначальное значение \TT{LockCount}
в регистре \TT{EBX}.
...
\EN{In this case, it adds 1 to \TT{LockCount}, meanwhile saves initial value of \TT{LockCount} in the \TT{EBX} register.
