...
% subsections
\input{patterns/01_helloworld/ARM/keil_ARM_DE}
\input{patterns/01_helloworld/ARM/keil_T_DE}
\input{patterns/01_helloworld/ARM/xcode_ARM_DE}
\input{patterns/01_helloworld/ARM/xcode_T2_DE}
\input{patterns/01_helloworld/ARM/ARM64_DE}
